...
```python
ZONES = {
    "safe": {"colour": "green", "pause_ms": 0},
    "caution": {"colour": "amber", "pause_ms": 600},
    "stop": {"colour": "red", "pause_ms": 120},
}
```

A dictionary maps unique keys to values. Changing configuration should not
require rewriting measurement logic.
